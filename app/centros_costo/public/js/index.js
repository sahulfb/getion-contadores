...
let editar = {
    ...
    inputIdCentroCosto: document.getElementById('editar-input-idCentroCosto'),
...
let eliminar = {
    ...
    inputIdCentroCosto: document.getElementById('eliminar-input-idCentroCosto'),
...
let tabla = $('#'+idTabla).DataTable( {
    "processing": true,
    "serverSide": true,
    "ajax": `${BASE_URL}/Centros_costo/CRUD/Consultar/`,
    "columns": [
        {
            "data": "idCentroCosto",
 ...
 */
function Registrar() {
    let url = `${BASE_URL}/Centros_costo/CRUD/Registrar/`;
    ...
    AJAX.enviar({
        ...
        error: function(mensaje) {
            Loader.hide();
            Alerta.danger('Registrar centro de costo', mensaje);
        },
        ok: function(data) {
            nuevo.form.reset();
            RefrescarTabla();
...
function ModalEditar(data) {
    editar.inputIdCentroCosto.value = data.idCentroCosto;
 ...
 */
function Editar() {
    let url = `${BASE_URL}/Centros_costo/CRUD/Modificar/`;
    ...
    AJAX.enviar({
        ...
        error: function(mensaje) {
            Loader.hide();
            Alerta.danger('Modificar centro de costo', mensaje);
        },
        ok: function(data) {
            RefrescarTabla();
            Loader.hide();
...
function ModalEliminar(data) {
    eliminar.inputIdCentroCosto.value = data.idCentroCosto;
 ...
 */
function Eliminar() {
    let url = `${BASE_URL}/Centros_costo/CRUD/Eliminar/`;
    ...
    AJAX.enviar({
        ...
        error: function(mensaje) {
            Loader.hide();
            Alerta.danger('Eliminar centro de costo', mensaje);
        },
        ok: function(data) {
            RefrescarTabla();
            Loader.hide();
